    ...
    (0, $37aec4d01f6984fa$export$2e2bcd8739ae039)(Block, [
        ...
        },
        {
            ...
            value: function componentDidUpdate(oldProps, newProps) {
                console.log("CDU");
                if (!(0, $e83b0d2deeb4dcc6$export$2e2bcd8739ae039)(oldProps, newProps)) {
...
$535ec53cbbbf8fb5$var$store.set("chats", {
    items: {
        id: 1000,
        title: "No Chats"
    }
});
$535ec53cbbbf8fb5$var$store.set("messages", {
    items: [
        {
            date: "12.10.22 08:30",
            text: "Hi there",
...
var $535ec53cbbbf8fb5$export$2e2bcd8739ae039 // set(state, 'user.name', 'John');
    ...
    return function(Component) {
        return /*#__PURE__*/ function(Component) {
            ...
            function _class(props) {
                ...
                var state = mapStateToProps((0, $535ec53cbbbf8fb5$export$2e2bcd8739ae039).getState());
                _this = _super.call(this, "div", (0, $cdc126d7edb6db3b$export$2e2bcd8739ae039)({}, props, state));
                // console.log(props)
                // console.log(state)
                ...
                (0, $535ec53cbbbf8fb5$export$2e2bcd8739ae039).on((0, $535ec53cbbbf8fb5$export$84bc128a772952e2).Updated, function() {
                    ...
                    var newState = mapStateToProps((0, $535ec53cbbbf8fb5$export$2e2bcd8739ae039).getState());
                    console.log(state, newState);
                    console.log(!(0, $e83b0d2deeb4dcc6$export$2e2bcd8739ae039)(state, newState));
                    // если что-то из используемых данных поменялось, обновляем компонент
                    if (!(0, $e83b0d2deeb4dcc6$export$2e2bcd8739ae039)(state, newState)) {
                        console.log("connect");
                        _this.setProps((0, $cdc126d7edb6db3b$export$2e2bcd8739ae039)({}, newState));
                    }
...
//# sourceMappingURL=index.78f32dfe.js.map
