...
var $c53c9d43678cab83$export$2e2bcd8739ae039 = /*#__PURE__*/ function() {
    "use strict";
    function Block() {
        var tag = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "div", propsAndChilds = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        (0, $d011ed1ae59d077b$export$2e2bcd8739ae039)(this, Block);
        var ref = this.getChildren(propsAndChilds), children = ref.children, props = ref.props;
    ...
    (0, $37aec4d01f6984fa$export$2e2bcd8739ae039)(Block, [
        ...
        },
        {
            ...
            value: function init() {
                var ref;
                this._element = this.createDocumentElement((ref = this._meta) === null || ref === void 0 ? void 0 : ref.tag);
        ...
        },
        {
            ...
            value: function createDocumentElement(tag) {
                ...
                if ((ref = this._props.settings) === null || ref === void 0 ? void 0 : ref.withInternalID) element.setAttribute("data-id", this._id);
                return element;
            }
        },
        {
        ...
        {
            key: "getChildren",
            value: function getChildren(propsAndChilds) {
                var children = {};
                var props = {};
                Object.keys(propsAndChilds).forEach(function(key) {
        ...
        },
        {
            ...
            value: function setProps(newProps) {
                if (!newProps) return;
                var ref = this.getChildren(newProps), children = ref.children, props = ref.props;
            ...
            value: function makePropsProxy(props) {
                ...
                return new Proxy(props, {
                    ...
                    set: function(target, prop, value) {
                        var oldValue = (0, $cdc126d7edb6db3b$export$2e2bcd8739ae039)({}, target);
                        target[prop] = value;
                        _this._eventBus.emit(Component.EVENT_FLOW_CDU, oldValue, target);
                        return true;
                    }
                });
            }
...
(0, $f32bfd8434ef5009$export$2e2bcd8739ae039)($c53c9d43678cab83$export$2e2bcd8739ae039, "EVENT_INIT", "init");
(0, $f32bfd8434ef5009$export$2e2bcd8739ae039)($c53c9d43678cab83$export$2e2bcd8739ae039, "EVENT_FLOW_CDM", "flow:component-did-mount");
(0, $f32bfd8434ef5009$export$2e2bcd8739ae039)($c53c9d43678cab83$export$2e2bcd8739ae039, "EVENT_FLOW_CDU", "flow:component-did-update");
(0, $f32bfd8434ef5009$export$2e2bcd8739ae039)($c53c9d43678cab83$export$2e2bcd8739ae039, "EVENT_FLOW_RENDER", "flow:render");
...
//# sourceMappingURL=index.6ce1306e.js.map
